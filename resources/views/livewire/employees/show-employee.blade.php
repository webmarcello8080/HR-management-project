...
<div class="rounded-container">
    ...
    <div class="flex items-start gap-8">
        <div class="rounded-xl border border-grey/20 basis-[275px] grow-0 shrink-0 overflow-hidden">
            ...
            <div wire:click='setMenuTab(3)' class="menu-tabs @if($menuTab == 3) active @endif">@svg('dollar', 'w-6 h-6') <span>Payrolls</span></div>
        ...
        <div class="grow">
            ...
            @endif
            @if ($menuTab == 3)
                @include('partials.payrolls.payroll-table', ['payrolls' => $employee->payrolls, 'display_user' => false])
            @endif
            @if ($menuTab == 4)
